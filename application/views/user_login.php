...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <header class="bg-blue-800 text-white p-12 text-center">
        <h1 class="text-5xl font-extrabold mb-4">User Login</h1>
        <p class="text-lg text-gray-200">Please enter your credentials to log in to your account.</p>
    </header>

    <!-- Login Form Section -->
    <main class="flex-grow p-8">
        <div class="container mx-auto max-w-md bg-white rounded-lg shadow-md p-8">
            <h2 class="text-3xl font-semibold text-center text-blue-800 mb-6">Welcome Back!</h2>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        localStorage.setItem('user_id', response.user_id);  // Store the user ID
